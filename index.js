...
.addField(`void - Teşekkürler diler`)
.addField(`void - Prefix(*)`, `void music botun prefixi(*)`)
.addField(`void Music - Nasıl Kullanılır?`, `void Music botun tüm özelliklerinden yararlanabilmek için sadece *yardım yazmanız gerekmektedir.`)
.addField(`void Music - Linkler`, `Destek Sunucumuz henüz yok`)
.setFooter(`void Music © 2020`)
.setTimestamp()
...
client.user.setActivity(`*yardım | void music `,{ type: 'LİSTENİNG' });
});
client.login(fynx.fynxtoken)
.then(function() {
console.log('[void] Token doğru. Bot aktif ediliyor.')
}, function(err) {
